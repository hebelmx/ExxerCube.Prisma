...
/// <summary>
/// CL-52: Validates that the issuer (emisor) RFC extracted from the CFDI fiscal block
...
/// </remarks>
internal sealed class Cl52IssuerRfcRule : IVecValidationRule
{
    ...
    public Result<RuleFinding> Evaluate(VerificationContext ctx, CancellationToken ct = default)
    {
        ...
        return Result<RuleFinding>.WithSuccess(
            RuleFinding.Fail(
                ...
                engineVersion: Version,
                expected: @"Issuer RFC matching ^[A-ZÑ&]{3,4}\d{6}[A-Z0-9]{3}$",
