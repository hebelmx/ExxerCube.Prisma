...
/// </summary>
/// <remarks>
/// Grown incrementally across the SIARA-AUTH-DESIGN tasks: S5 adds <see cref="Passthrough"/>; the
/// <see cref="AuthMode"/> selector plus the interactive/automated sub-options and the resolver wiring
/// land in S7. Bind from the <c>Siara</c> configuration section.
/// </remarks>
