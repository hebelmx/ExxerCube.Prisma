...
public interface IOutputWriter
{
    ...
    Task<Result<bool>> WriteResultAsync(ProcessingResult result, string outputPath);
    ...
    /// <returns>A result indicating success or failure.</returns>
    Task<Result<bool>> WriteResultsAsync(IEnumerable<ProcessingResult> results, string outputDirectory);
    ...
    /// <param name="outputPath">The output file path.</param>
    /// <returns>A result indicating success or failure.</returns>
    Task<Result<bool>> WriteJsonAsync(ProcessingResult result, string outputPath);
    ...
    /// <param name="outputPath">The output file path.</param>
    /// <returns>A result indicating success or failure.</returns>
    Task<Result<bool>> WriteTextAsync(ProcessingResult result, string outputPath);
}
