...
public sealed class SignalRIngestionBroadcasterTests
{
    ...
    private static IOptions<ProcessIdentityOptions> DefaultOptions() =>
        Options.Create(new ProcessIdentityOptions { Clearance = ProcessClearance.Download });
    ...
    {
        // Arrange: configure clearance to Download (as Orion appsettings would).
        ...
        var configuredClearance = ProcessClearance.Download;
