...
/// <returns>A result indicating success or failure.</returns>
Task<Result<bool>> RecordDownloadAsync(FileMetadata fileMetadata);
...
/// <returns>A result indicating success or failure.</returns>
Task<Result<bool>> LogMetadataAsync(FileMetadata metadata);
...
/// <returns>A result indicating success or failure.</returns>
Task<Result<bool>> LogActionAsync(AuditAction action, string fileId, Dictionary<string, object>? details = null);
...
/// <returns>A result indicating success or failure.</returns>
Task<Result<bool>> LogClassificationDecisionAsync(string fileId, ClassificationResult classification, ClassificationScores scores);
...
/// <returns>A result indicating success or failure.</returns>
Task<Result<bool>> SubmitReviewDecisionAsync(string caseId, ReviewDecision decision);
...
public class Expediente
{
    ...
    public List<SolicitudEspecifica> SolicitudEspecifica { get; set; }
}
```
