...
Configuration: Pop=30, Gen=40, ~3 hours
"""
...
class Cluster2PILOptimizationProblem(Problem):
    def __init__(self, base_path: Path, ground_truth: Dict[str, str]):
        ...
        self.eval_count = 0
        self.log_file = base_path / "cluster2_pil_progress.log"
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        for x in X:
            ...
            for tc in self.test_cases:
                ...
                temp_path = self.base_path / f"temp_ocr_c2pil_{self.eval_count}.png"
...
def main():
    ...
    print("="*80)
    print("NSGA-II CLUSTER 2 PIL PIPELINE OPTIMIZATION")
    print("="*80)
    print()
    ...
    problem = Cluster2PILOptimizationProblem(base_path, ground_truth)
    ...
    output_file = base_path / "cluster2_pil_pareto_front.json"
