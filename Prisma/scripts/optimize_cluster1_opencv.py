...
class Cluster1OpenCVOptimizationProblem(Problem):
    def __init__(self, base_path: Path, ground_truth: Dict[str, str]):
        ...
        self.eval_count = 0
        self.log_file = base_path / "cluster1_opencv_progress.log"
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        for x in X:
            ...
            for tc in self.test_cases:
                ...
                temp_path = self.base_path / f"temp_ocr_c1opencv_{self.eval_count}.png"
...
def main():
    ...
    print("="*80)
    print("NSGA-II CLUSTER 1 OPENCV PIPELINE OPTIMIZATION")
    print("="*80)
    print()
    ...
    problem = Cluster1OpenCVOptimizationProblem(base_path, ground_truth)
    ...
    output_file = base_path / "cluster1_opencv_pareto_front.json"
