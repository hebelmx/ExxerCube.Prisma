...
if has_cuda:
    # bf16 on Ampere+ (A2000 yes), fp16 otherwise (1060/3060 fine)
...
USER_PROMPT = (
    "Analyze this scanned legal document (in Spanish) and extract the following JSON. "
    "If unsure about any field, use 'unknown'. The model may backtrack internally; do not guess. "
    "Output ONLY valid JSON, with double quotes on all keys and string values.\n\n"
    f"{json.dumps(JSON_SPEC, ensure_ascii=False, indent=2)}"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image", required=False, default="F:\\Dynamic\\ExxerCubeBanamex\\ExxerCube.Prisma\\Prisma\\Docs Sistema\\DumyPrisma1.png", help="Path to input image (default: DumyPrisma1.png)")
