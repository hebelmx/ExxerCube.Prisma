...
| [`product/`](product/) | Epics, user stories, PRD, requirements |
| [`development/`](development/) | Guides, implementation status, session handoffs, lessons learned |
| [`qa/`](qa/) | QA gates, code reviews, test plans, analysis reports |
| [`planning/`](planning/) | Gap analysis, presentations, mission plans |
...
- **`legal/samples/`** -- Reference SIARA document samples (docx/pdf/xml)
...
- **`product/epics/`** -- Epic definitions (Missions 1-7, system testing)
- **`product/stories/`** -- User stories (1.1-1.10, Python sprint stories)
- **`product/requirements/`** -- PRD, front-end spec, UI architecture, fusion requirements
...
- **`development/sessions/`** -- Agent session handoff notes
...
- **`qa/gates/`** -- QA gate YAML files (per-story acceptance criteria)
- **`qa/reviews/`** -- Due diligence reviews, code reviews, audit reports
- **`qa/test-plans/`** -- Test plans, coverage analysis, fixture status
- **`qa/reports/analysis/`** -- JSON/TXT analysis reports, build outputs
- **`qa/reports/archive/`** -- Historical error logs

## Planning

- **`planning/gap-analysis/`** -- Gap assessments, action plans, ITDD/phase documents
- **`planning/presentations/`** -- Presentation checklists, stakeholder readiness
- **`planning/missions/`** -- Mission-based planning (Missions 1-5)
